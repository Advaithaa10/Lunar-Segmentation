...
st.set_page_config(page_title = "Moon Segmentation App", page_icon = ":moon:")

# URL of your FastAPI backend endpoint for image segmentation
FASTAPI_URL = "http://127.0.0.1:8000/segment/"

# Streamlit application setup
st.title("Lunar Surface Image Segmentation App")
